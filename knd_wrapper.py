...
if __name__ == '__main__':
    formatter_class=lambda prog: HelpFormatter(prog,max_help_position=50, width=100)
    parser = ArgumentParser(description='Kubernetes NGINX Deployer',formatter_class=formatter_class)
    parser.add_argument('-r', '--replicas', metavar='<no-of-replicas>', type=int, dest='replicas', action='store', help='Specify no of replicas', required=True)
